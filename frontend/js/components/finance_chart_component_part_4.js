/**
 * LifeOS Production UI Component — Finance Cashflow Chart Component Part 4
 */

export class FinanceChartComponentPart4 {
    ...
    this.container.innerHTML = `
      <div class="card widget-card-part-4">
        <div class="card-header">
          <div class="card-title">Finance Cashflow Chart Component #4</div>
