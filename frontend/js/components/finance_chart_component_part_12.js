/**
 * LifeOS Production UI Component — Finance Cashflow Chart Component Part 12
 */

export class FinanceChartComponentPart12 {
    ...
    this.container.innerHTML = `
      <div class="card widget-card-part-12">
        <div class="card-header">
          <div class="card-title">Finance Cashflow Chart Component #12</div>
