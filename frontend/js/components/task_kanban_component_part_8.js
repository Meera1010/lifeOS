/**
 * LifeOS Production UI Component — Task Kanban & Detail Drawer Component Part 8
 */

export class TaskKanbanComponentPart8 {
    ...
    this.container.innerHTML = `
      <div class="card widget-card-part-8">
        <div class="card-header">
          <div class="card-title">Task Kanban & Detail Drawer Component #8</div>
