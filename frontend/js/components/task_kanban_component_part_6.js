/**
 * LifeOS Production UI Component — Task Kanban & Detail Drawer Component Part 6
 */

export class TaskKanbanComponentPart6 {
    ...
    this.container.innerHTML = `
      <div class="card widget-card-part-6">
        <div class="card-header">
          <div class="card-title">Task Kanban & Detail Drawer Component #6</div>
