/**
 * LifeOS Production UI Component — Finance Cashflow Chart Component Part 9
 */

export class FinanceChartComponentPart9 {
    ...
    this.container.innerHTML = `
      <div class="card widget-card-part-9">
        <div class="card-header">
          <div class="card-title">Finance Cashflow Chart Component #9</div>
