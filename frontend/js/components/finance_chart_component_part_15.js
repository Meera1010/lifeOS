/**
 * LifeOS Production UI Component — Finance Cashflow Chart Component Part 15
 */

export class FinanceChartComponentPart15 {
    ...
    this.container.innerHTML = `
      <div class="card widget-card-part-15">
        <div class="card-header">
          <div class="card-title">Finance Cashflow Chart Component #15</div>
