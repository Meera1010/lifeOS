/**
 * LifeOS Production UI Component — Finance Cashflow Chart Component Part 8
 */

export class FinanceChartComponentPart8 {
    ...
    this.container.innerHTML = `
      <div class="card widget-card-part-8">
        <div class="card-header">
          <div class="card-title">Finance Cashflow Chart Component #8</div>
