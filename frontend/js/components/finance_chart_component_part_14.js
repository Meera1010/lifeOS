/**
 * LifeOS Production UI Component — Finance Cashflow Chart Component Part 14
 */

export class FinanceChartComponentPart14 {
    ...
    this.container.innerHTML = `
      <div class="card widget-card-part-14">
        <div class="card-header">
          <div class="card-title">Finance Cashflow Chart Component #14</div>
