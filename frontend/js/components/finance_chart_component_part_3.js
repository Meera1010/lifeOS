/**
 * LifeOS Production UI Component — Finance Cashflow Chart Component Part 3
 */

export class FinanceChartComponentPart3 {
    ...
    this.container.innerHTML = `
      <div class="card widget-card-part-3">
        <div class="card-header">
          <div class="card-title">Finance Cashflow Chart Component #3</div>
