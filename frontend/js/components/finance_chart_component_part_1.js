/**
 * LifeOS Production UI Component — Finance Cashflow Chart Component Part 1
 */

export class FinanceChartComponentPart1 {
    ...
    this.container.innerHTML = `
      <div class="card widget-card-part-1">
        <div class="card-header">
          <div class="card-title">Finance Cashflow Chart Component #1</div>
