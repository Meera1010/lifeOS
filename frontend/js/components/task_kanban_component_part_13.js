/**
 * LifeOS Production UI Component — Task Kanban & Detail Drawer Component Part 13
 */

export class TaskKanbanComponentPart13 {
    ...
    this.container.innerHTML = `
      <div class="card widget-card-part-13">
        <div class="card-header">
          <div class="card-title">Task Kanban & Detail Drawer Component #13</div>
