/**
 * LifeOS Production UI Component — Task Kanban & Detail Drawer Component Part 4
 */

export class TaskKanbanComponentPart4 {
    ...
    this.container.innerHTML = `
      <div class="card widget-card-part-4">
        <div class="card-header">
          <div class="card-title">Task Kanban & Detail Drawer Component #4</div>
