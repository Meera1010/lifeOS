/**
 * LifeOS Production UI Component — Finance Cashflow Chart Component Part 5
 */

export class FinanceChartComponentPart5 {
    ...
    this.container.innerHTML = `
      <div class="card widget-card-part-5">
        <div class="card-header">
          <div class="card-title">Finance Cashflow Chart Component #5</div>
