/**
 * LifeOS Production UI Component — Task Kanban & Detail Drawer Component Part 1
 */

export class TaskKanbanComponentPart1 {
    ...
    this.container.innerHTML = `
      <div class="card widget-card-part-1">
        <div class="card-header">
          <div class="card-title">Task Kanban & Detail Drawer Component #1</div>
