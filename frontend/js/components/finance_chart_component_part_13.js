/**
 * LifeOS Production UI Component — Finance Cashflow Chart Component Part 13
 */

export class FinanceChartComponentPart13 {
    ...
    this.container.innerHTML = `
      <div class="card widget-card-part-13">
        <div class="card-header">
          <div class="card-title">Finance Cashflow Chart Component #13</div>
