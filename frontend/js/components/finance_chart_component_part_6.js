/**
 * LifeOS Production UI Component — Finance Cashflow Chart Component Part 6
 */

export class FinanceChartComponentPart6 {
    ...
    this.container.innerHTML = `
      <div class="card widget-card-part-6">
        <div class="card-header">
          <div class="card-title">Finance Cashflow Chart Component #6</div>
