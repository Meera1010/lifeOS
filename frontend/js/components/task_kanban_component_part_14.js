/**
 * LifeOS Production UI Component — Task Kanban & Detail Drawer Component Part 14
 */

export class TaskKanbanComponentPart14 {
    ...
    this.container.innerHTML = `
      <div class="card widget-card-part-14">
        <div class="card-header">
          <div class="card-title">Task Kanban & Detail Drawer Component #14</div>
