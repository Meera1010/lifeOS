/**
 * LifeOS Production UI Component — Finance Cashflow Chart Component Part 2
 */

export class FinanceChartComponentPart2 {
    ...
    this.container.innerHTML = `
      <div class="card widget-card-part-2">
        <div class="card-header">
          <div class="card-title">Finance Cashflow Chart Component #2</div>
